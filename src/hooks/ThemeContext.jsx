...
export const THEME_CONFIGS = [
  ...
  },
  {
    ...
    name: 'Desert',
    icon: '⏳',
    gradient: 'linear-gradient(to bottom, #1f1105 0%, #301a07 60%, #45260a 100%)',
    colors: {
      'space-950': '#120802',
      'space-900': '#1f1105',
      'space-800': '#301a07',
  ...
  },
  {
    ...
    name: 'Cyberpunk',
    icon: '🤖',
    gradient: 'linear-gradient(to bottom, #0d0415 0%, #150625 60%, #20083a 100%)',
    colors: {
      'space-950': '#06020a',
      'space-900': '#0d0415',
      'space-800': '#150625',
  ...
  },
  {
    ...
    name: 'Neon',
    icon: '💡',
    gradient: 'linear-gradient(to bottom, #020205 0%, #05050e 60%, #0c0c20 100%)',
    colors: {
      'space-950': '#010103',
      'space-900': '#020205',
      'space-800': '#05050e',
      'space-700': '#0c0c20',
      'nebula-purple': '#ff007f',
      'nebula-blue': '#00ffff',
      'nebula-pink': '#39ff14',
      'theme-from': '#00ffff',
      'theme-via': '#ff007f',
